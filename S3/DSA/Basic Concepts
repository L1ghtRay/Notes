...
f(x) = O(g(n)) (read as “f of n is big oh of g of n”) iff (if and only if) there exist positive constants c and n<sub>0</sub> such that f(n) ≤ cg(n) for all n, n ≥ n<sub>0</sub>.

![[Pasted image 20240902220518.png]]
## Big Ω

f(n) = Ω(g(n)) (read as “f of n is big omega of g of n”) iff there exist positive constants c and n<sub>0</sub> such that f(n) ≥ cg(n) for all n, n ≥ n<sub>0</sub>.

![[Pasted image 20240902220533.png]]
## Big Θ

f(n) = Θ(g(n)) (read as “f of n is nig theta of g of n”) iff there exist positive constants c<sub>1</sub>, c<sub>2</sub> and n<sub>0</sub> such that c<sub>1</sub>g(n) ≤ f(n) ≤ c<sub>2</sub>g(n) for all n, n ≥ n<sub>0</sub>.
